...
$this->title = 'Nutzungsbe&shy;dingungen';
...
<div class="site-terms">
    ...
    <h4>Absoluter Haftungsauschluss</h4>
    <p>
        Da der Service kostenlos ist, wird dieser ohne JEDLICHE GEWÄHRLEISTUNG bereit gestellt. Wenn Ihnen das missfällt, dann NUTZEN SIE DEN SERVICE NICHT.
    </p>

    <h4>Nutzungseinschränkung</h4>
    <p>
        Es ist ausdrücklich verboten, den Service für das von IHNEN VERANLASSTE Versenden von massenhaften SPAM-Mails zu nutzen (sprich: SIE selbst oder jemand, den SIE dazu veranlasst haben, sind der Spammer!). 
    </p>

    <h4>Löschvorbehalt</h4>
    <p>
    ...
    <p>
        <i>Für den eher unwahrscheinlichen Fall einer Einstellung würden wir aber die Domäne mailwitch.com so lange nicht zurück geben, wie dies irgendwie wirtschaftlich haltbar/vertretbar ist. Damit würde ein Missbrauch der bestehenden Adressen bestmöglich verhindert.</i>
    </p>
